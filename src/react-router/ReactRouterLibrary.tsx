...
// http://localhost:3000 일때 보여주고 싶음
// http://localhost:3000/router
export default function ReactRouterLibrary() {

  //* - <a></a> 요소로 페이지 전환을 하게되면 새로운 요청을 보내게되어 반드시 페이지가 새로고침됨
  ...
  //* - 해당 <Link> 컴포넌트를 클릭했을 때 다른 작업을 같이 수행하고자 한다면 그 작업이 정상적으로 수행되지 않음  (promise)
...
// http://localhost:3000/page1 일때 보여주고 싶음
// http://localhost:3000/router/page1
export function ReactRouterPage1 () {
  return <h1>페이지 1</h1>
}

// http://localhost:3000/page2 일때 보여주고 싶음
